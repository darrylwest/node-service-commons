...
var AbstractServiceFactory = function(options) {
    'use strict';
    ...
    this.createIndexPageService = function() {
        var service = services[ IndexPageService.SERVICE_NAME ];
    ...
    this.createWebStatusService = function() {
        var service = services[ WebStatusService.SERVICE_NAME ];
...
AbstractServiceFactory.extend = function(child, options) {
    'use strict';
    var parent = new AbstractServiceFactory( options );
